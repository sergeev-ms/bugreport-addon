...
public class BugreportTestContainer extends TestContainer {

    public BugreportTestContainer() {
        super();
        ...
        appPropertiesFiles = Arrays.asList(
                ...
                "com/borets/bugreport/app.properties",
    ...
    public static class Common extends BugreportTestContainer {

        public static final BugreportTestContainer.Common INSTANCE = new BugreportTestContainer.Common();
